function [q, ctrfilter, perform, rankcheck] = calculatefVAST(general, array, zone, ctrfilter, ATFs, dummy, bandoption, taroption)
% function [q, ctrfilter, perform, rankcheck] = calculatefVAST(general, array, zone, ctrfilter, rirs, drirs, dummy, bandoption, taroption)
...
% ctrfilter.cvxopt_properties.findopt = true; % yq
...
Hml = {ATFs.Hml1; ATFs.Hml2};
Dm = {ATFs.Dm1; ATFs.Dm2};

dF = general.fs/general.lenConFilter;
freq = (0:dF:general.fs/2)'; % yq e* —— (0:
